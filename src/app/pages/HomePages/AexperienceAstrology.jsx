    ...
    <div className="bg-gradient-to-r from-[#FFD700] via-[#FFD700] to-[#FF9933] flex flex-col md:flex-row items-center justify-between md:py-20 py-10 px-6 lg:px-16  shadow-lg mt-16 gap-10 md:gap-0 ">
      ...
      <div className=" text-center md:text-left flex flex-col items-center md:items-start justify-center w-full md:w-1/2 space-y-5">
        ...
        {/* <div className="flex flex-col md:flex-row items-center gap-4">
          <button className="text-sm lg:text-base bg-gradient-to-r from-[#FF6F00] to-[#FFD700] text-white font-semibold px-4 sm:px-2 lg:px-6 py-1 md:py-2 rounded-full shadow-md hover:shadow-lg transition-all duration-300 ease-out">
            Check Free Kundli
          </button>
          <button className="text-sm lg:text-base border-2 border-[#FF6F00] text-[#5A3E00] px-4 sm:px-2 lg:px-6 py-1 md:py-2 rounded-full font-semibold hover:bg-[#FFF8E1] hover:text-[#FF6F00] transition-all duration-300 ease-out">
        ...
        <div className="flex justify-center md:justify-start gap-4 mt-6 text-[#5A3E00] font-medium">
          <span className="bg-[#FFF5E1] px-2 md:px-4 py-2 lg:text-base text-xs rounded-full shadow-inner">
            🔮 Trusted by 1L+ Users
          </span>
          <span className="bg-[#FFF5E1] px-2 md:px-4 py-2 lg:text-base text-xs rounded-full shadow-inner">
  ...
  transition={{ duration: 0.7, ease: "easeOut" }} // duration in seconds
      ...
      className=" w-full md:w-1/2 flex justify-center md:justify-end relative">
        <img
          ...
          className="w-[380px] md:w-[420px] lg:w-[600px] rounded-2xl shadow-2xl animate-fadeIn"
        />
